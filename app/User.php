...
class User extends Authenticatable
{
    ...
    public function guardacompra(){
        ...
        $client->request('GET', 'http://smsgateway.me/api/v3/messages/send?email=bustamantelujano@gmail.com&password=1234554321&device=34855&number='.$this->telefono.'&message='.$this->name.', muchas gracias por tu compra, puede ver su recibo en cvashop.herokuapp.com/compra/'.$idrecibo);
